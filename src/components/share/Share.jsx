    ...
    <div className="home__share">
      <div className="home__share-wrapper">
        <div className="home__share-top flex">
          <img src={user.profilePictureID[0]} alt="profile pic" className="small-profile-pic home__share-img" />
          <textarea rows="2" className="home__share-input" placeholder={`What's on your mind, ${user.name.first}?`} style={{ resize: 'none', fontFamily: 'roboto', fontSize: '1em' }} />
        </div>
